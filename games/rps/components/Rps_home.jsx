...
export default function home() {
  ...
  const [basicGameData, setBasicGameData] = useState({ round: 1, wonName: '', wonChoice: '', ownWinCount: 0, opponentWinCount: 0 });
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (getBettingDataFetch.isBetFound === false && getBettingDataFetch.isBetFound !== undefined) {
          setIsBetFound(false);
          return;
        }
